...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'ktdmReqCby9MuJR1HcLO8Ouh1aSQSfKJ',
            'parsers' => [
        ...
        'smsPilot' => [
            ...
            'apiKey' => getenv('SMS_PILOT_API_KEY') ?: 'EMULATOR',
            'simulate' => getenv('SMS_PILOT_API_KEY') ? false : true,
        ],
        'notificationService' => [
            'class' => app\components\NotificationService::class,
        ],
        'topAuthorReport' => [
            'class' => app\components\TopAuthorReportService::class,
        ],
        'authorService' => [
